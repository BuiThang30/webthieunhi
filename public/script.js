...
const posts = [
  { title: "But what about economics?", url: "http://localhost:3000/blog2?slide=1" },
  { title: "But what is a market?", url: "http://localhost:3000/blog2?slide=2" },
  { title: "The economics of midnight studying", url: "http://localhost:3000/blog2?slide=3" },
  { title: "But what the hell is demand?", url: "http://localhost:3000/blog2?slide=4" },
  { title: "Changing demand - How do you come to want more or less of something?", url: "http://localhost:3000/blog2?slide=5" },
  { title: "Now, what is supply?", url: "http://localhost:3000/blog2?slide=6" },
  { title: "Changing Supply - When producers respond to their costs", url: "http://localhost:3000/blog2?slide=7" },
  { title: "Understanding Price Elasticity of Demand", url: "http://localhost:3000/blog2?slide=8" },
  { title: "Dive into Income Elasticity of Demand", url: "http://localhost:3000/blog2?slide=9" },
  { title: "How stretchy is your supply?", url: "http://localhost:3000/blog2?slide=10" },
  { title: "Market equilibrium", url: "http://localhost:3000/blog2?slide=11" },
  { title: "The wealth of a nation", url: "http://localhost:3000/blog2?slide=12" },
  { title: "The driving force of the economy", url: "http://localhost:3000/blog2?slide=13" },
  { title: "The backbone of our modern life", url: "http://localhost:3000/blog2?slide=14" },
  { title: "Why is our money so weird?", url: "http://localhost:3000/blog2?slide=15" },
  { title: "Market Reserves - Destroy The Curves", url: "http://localhost:3000/blog2?slide=16" },
  { title: "Fiscal policy and monetary policy", url: "http://localhost:3000/blog2?slide=17" },
  { title: "Exchange rate", url: "http://localhost:3000/blog2?slide=18" },
  { title: "Unemployment", url: "http://localhost:3000/blog2?slide=19" },
  { title: "IF SOME COUNTRIES ARE MORE PRODUCTIVE, THEN WHY WOULD THEY TRADE WITH OTHER COUNTRIES? - COMPARATIVE ADVANTAGE & ABSOLUTE ADVANTAGE", url: "http://localhost:3000/blog2?slide=20" },
  { title: "PROSPERITY OR PRESERVING TRADITIONS?", url: "http://localhost:3000/blog2?slide=21" },
  { title: "You cannot be the jack of all academic trade", url: "http://localhost:3000/blog2?slide=22" },
  { title: "Know your strengths, and be accepting of your limits", url: "http://localhost:3000/blog2?slide=23" },
  { title: "THỪA CÒN HƠN THIẾU(EXCESS THAN LACK) - IS IT ALWAYS TRUE?", url: "http://localhost:3000/blog2?slide=24" },
  { title: "GIVING IT ALL TO TOP EVERY EXAM YOU SIT FOR? HERE IS WHY IT IS NOT WORTH IT FROM THE LENS OF ECONOMICS.", url: "http://localhost:3000/blog2?slide=25" },
  { title: "Studying in a group of learners - standing on the shoulders of academic giants", url: "http://localhost:3000/blog2?slide=26" }
];
